...
<form action="<?= $entry->url('recover_password') ?>" method="POST" onsubmit="return confirm('This will send an email with password recovery instructions to the owner of this entry. Is that okay?')" style="text-align: center;">
